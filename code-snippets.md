...
async function doIt() {
    console.time("doIt");
    const time1 = 300;
    const time2 = await step1(time1);  //step1 with 300
    const time3 = await step2(time1, time2);  //step2 with 300 and 500
    const result = await step3(time1, time2, time3);  //step3 with 300, 500 and 1000
    console.log(`result is ${result}`); //result is 2000
